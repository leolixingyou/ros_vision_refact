...
class BaseEngine(object):
    ...
    def draw_2D(self, image, alpha = 0.5, text=True):
        ...
        return front_view, mask, self.all_ms
...
if __name__ == '__main__':
    ...
    # parser.add_argument('-e', '--engine', default="./segmentation/weights/None_384x640_sim_3.trt")  
    parser.add_argument('-e', '--engine', default="./segmentation/weights/hybridnets_c0_384x640_simplified.trt") 
